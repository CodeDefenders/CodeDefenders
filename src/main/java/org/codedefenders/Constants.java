...
public class Constants {
	...
	public static final String MUTANT_INVALID_MESSAGE = "Sorry, your mutant is invalid: it either is identical to the original class (or an existing mutant) or contains invalid code (ifs, loops, or new disjunctions).";
