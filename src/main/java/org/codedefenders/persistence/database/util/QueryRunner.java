...
public interface QueryRunner {
     ...
     */
    <T> T query(@Nonnull String sql, @Nonnull ResultSetHandler<T> mapper) throws SQLException;
     ...
     * @throws SQLException if a database access error occurs
     */
    <T> T query(@Nonnull String sql, @Nonnull ResultSetHandler<T> mapper, @Nonnull Object... params) throws SQLException;
     ...
     * @throws SQLException if a database access error occurs
     */
    <T> T insert(@Nonnull String sql, @Nonnull ResultSetHandler<T> mapper) throws SQLException;
     ...
     * @throws SQLException if a database access error occurs
     */
    <T> T insert(@Nonnull String sql, @Nonnull ResultSetHandler<T> mapper, @Nonnull Object... params) throws SQLException;
     ...
     * @throws SQLException if a database access error occurs
     */
    int update(@Nonnull String sql) throws SQLException;
     ...
     * @throws SQLException if a database access error occurs
     */
    int update(@Nonnull String sql, @Nonnull Object... params) throws SQLException;
     ...
     * @throws SQLException if a database access error occurs
     */
    int execute(@Nonnull String sql, @Nonnull Object... params) throws SQLException;
     ...
     * @throws SQLException if a database access error occurs
     */
    <T> List<T> execute(@Nonnull String sql, @Nonnull ResultSetHandler<T> mapper, @Nonnull Object... params) throws SQLException;
}
