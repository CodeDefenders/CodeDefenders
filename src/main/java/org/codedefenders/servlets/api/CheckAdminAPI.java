 ...
 */
@WebServlet("/api/auth/checkAdmin")
public class CheckAdminAPI extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(CheckAdminAPI.class);
    @Inject
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        root.add("admin", gson.toJsonTree(authService.isAdmin(), Boolean.class));
