...
VALUES (10, 0, 10, 'No smell free tests written', 'Write a test without test smells to unlock this achievement',
       ...
       (17, 0, 17, 'Not enough tests written in 5 minutes', 'Write two tests in 5 minutes to unlock this achievement',
        '{0} of {1} tests written in 5 minutes', 0),
       (17, 1, 17, 'Speedy Tester', 'Write {0} tests in 5 minutes',
        '{0} of {1} tests written in 5 minutes to reach the next level', 2),
       (17, 2, 17, 'Bronze Speedy Tester', 'Write {0} tests in 5 minutes',
        '{0} of {1} tests written in 5 minutes to reach the next level', 5),
       (17, 3, 17, 'Silver Speedy Tester', 'Write {0} tests in 5 minutes',
