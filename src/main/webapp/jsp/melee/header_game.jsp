    ...
    <nav class="nest" style="width: 100%; margin-left: 0; margin-right: auto;">
        <div class="crow fly">
            ...
            <div class="admin-panel col-md-12">
                ...
                <form id="adminEndBtn" action="<%=request.getContextPath() + Paths.MELEE_SELECTION%>" method="post" style="display: inline-block;">
                ...
                <form id="adminStartBtn" action="<%=request.getContextPath() + Paths.MELEE_SELECTION%>" method="post" style="display: inline-block;">
