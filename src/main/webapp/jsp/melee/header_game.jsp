	...
	<nav class="nest"
		...
		<div class="crow fly">
			...
			<div class="container">
				...
				</a> <a href="#" class="btn btn-default btn-diff" id="btnScoreboard"
					data-toggle="modal" data-target="#scoreboard">Scoreboard</a> <a
					href="#" class="btn btn-default btn-diff" id="btnFeedback"
