...
<div id="research" class="paper-list">
    <ul class="papercite_bibliography">
        <li>
            <a href="https://study.code-defenders.org/papers/SIGCSE19_Course.pdf" title="${i18n.tr('Download PDF')}"
               class="pdf_link">
                <img src='${url.forPath("/images/pdf.png")}' alt="${i18n.tr('[PDF]')}"/>
            </a>
            ...
            <a href="#" data-bs-toggle="collapse" data-bs-target="#sigcse19_bibtex">${i18n.tr('[Bibtex]')}</a>
...
<pre class="tex"><code>@inproceedings{SIGSCE_2019_CodeDefenders,
    ...
    year = {2019}
        ...
        <li>
            ...
            <a href="#" data-bs-toggle="collapse" data-bs-target="#ecsee18_course">${i18n.tr('[Bibtex]')}</a>
            <div id="ecsee18_course" class="bibtex collapse" >
<pre class="tex"><code>@inproceedings{ECSEE2018_CodeDefenders,
    ...
    year = {2018}
        ...
        <li>
            ...
            <a href="#" data-bs-toggle="collapse" data-bs-target="#icse17_edu_bibtex">${i18n.tr('[Bibtex]')}</a>
            <div id="icse17_edu_bibtex" class="bibtex collapse" >
<pre class="tex"><code>@inproceedings{ICSE_SEET2017_CodeDefenders,
    ...
    year = {2017}
        ...
        <li>
            ...
            <a href="#" data-bs-toggle="collapse" data-bs-target="#icse17_bibtex">${i18n.tr('[Bibtex]')}</a>
            <div id="icse17_bibtex" class="bibtex collapse" >
<pre class="tex"><code>@inproceedings{ICSE2017_CodeDefenders,
    ...
    year = {2017}
        ...
        <li>
            ...
            <a href="#" data-bs-toggle="collapse" data-bs-target="#ppig16_bibtex">${i18n.tr('[Bibtex]')}</a>
            <div id="ppig16_bibtex" class="bibtex collapse" >
<pre class="tex"><code>@inproceedings{PPIG16_TeachingTesting,
    ...
    year = {2016}
        ...
        <li>
            ...
            <a href="#" data-bs-toggle="collapse" data-bs-target="#ecsee16_bibtex">${i18n.tr('[Bibtex]')}</a>
            <div id="ecsee16_bibtex" class="bibtex collapse" >
<pre class="tex"><code>@inproceedings{ECSEE16_MutationEducation,
    ...
    note = {To appear}
        ...
        <li>
            ...
            <a href="#" data-bs-toggle="collapse" data-bs-target="#mutation16_bibtex">${i18n.tr('[Bibtex]')}</a>
            <div id="mutation16_bibtex" class="bibtex collapse" >
...
<script>
    function copyBibtex(buttonEl) {
        const texEl = buttonEl.parentElement.querySelector('.tex');
