...
//
	...
	public void testInfiniteParserRecursionWithSingleTokens() throws IOException, CodeValidatorException {
		final String code = String.join("\n",
				...
				"	}",
				"}");
		assertTrue(CodeValidator.validateTestCode(code, CodeValidator.DEFAULT_NB_ASSERTIONS, CodeValidator.DEFAULT_FORCE_HAMCREST));
	}
	...
	public void testMissingSemiColon() throws IOException, CodeValidatorException {
		...
		assertFalse(CodeValidator.validateTestCode(code, CodeValidator.DEFAULT_NB_ASSERTIONS, CodeValidator.DEFAULT_FORCE_HAMCREST));
	}
	...
	public void testInvalidSuiteWithTwoClasses() throws IOException, CodeValidatorException {
		...
		assertFalse("Should be invalid; file contains a two classes", CodeValidator.validateTestCode(code, DEFAULT_NB_ASSERTIONS, CodeValidator.DEFAULT_FORCE_HAMCREST));
	}
	...
	public void testInvalidEmptyTest() throws IOException, CodeValidatorException {
		...
		final String code = new String(Files.readAllBytes(Paths.get(url.getPath())));
		assertFalse(CodeValidator.validateTestCode(code, DEFAULT_NB_ASSERTIONS, CodeValidator.DEFAULT_FORCE_HAMCREST));
	}
	...
	public void testInvalidTwoTests() throws IOException, CodeValidatorException {
		...
		final String code = new String(Files.readAllBytes(Paths.get(url.getPath())));
		assertFalse("Should be invalid; class contains two tests", CodeValidator.validateTestCode(code, DEFAULT_NB_ASSERTIONS, CodeValidator.DEFAULT_FORCE_HAMCREST));
	}
	...
	public void testInvalidTestWithTooManyAssertions() throws IOException, CodeValidatorException {
		...
		final String code = new String(Files.readAllBytes(Paths.get(url.getPath())));
		assertFalse("Should be invalid; test has too many assertions", CodeValidator.validateTestCode(code, DEFAULT_NB_ASSERTIONS, CodeValidator.DEFAULT_FORCE_HAMCREST));
	}
	...
	public void testInvalidTestWithIf() throws IOException, CodeValidatorException {
		...
		final String code = new String(Files.readAllBytes(Paths.get(url.getPath())));
		assertFalse("Should be invalid; test contains if statement", CodeValidator.validateTestCode(code, DEFAULT_NB_ASSERTIONS, CodeValidator.DEFAULT_FORCE_HAMCREST));
	}
	...
	public void testInvalidTestWithSystemCalls() throws IOException, CodeValidatorException {
		...
		assertFalse("Should be invalid; test contains system call", CodeValidator.validateTestCode(code1, DEFAULT_NB_ASSERTIONS, CodeValidator.DEFAULT_FORCE_HAMCREST));
		...
		assertFalse("Should be invalid; test contains system call", CodeValidator.validateTestCode(code2, DEFAULT_NB_ASSERTIONS, CodeValidator.DEFAULT_FORCE_HAMCREST));
		...
		assertFalse("Should be invalid; test contains system call", CodeValidator.validateTestCode(code3, DEFAULT_NB_ASSERTIONS, CodeValidator.DEFAULT_FORCE_HAMCREST));
	}
	...
	public void testValidTest() throws IOException, CodeValidatorException {
		...
		final String code = new String(Files.readAllBytes(Paths.get(url.getPath())));
		assertTrue("Should be valid", CodeValidator.validateTestCode(code, DEFAULT_NB_ASSERTIONS, CodeValidator.DEFAULT_FORCE_HAMCREST));
	}
