...
public class StaticAnalysesTest {
    ...
    public void testUncoverableLinesIdentification() {
        ...
        // There are 35 lines that are method/constructor signatures or
        // annotations
        // CodeDefenders currently identifies 17 closing braces.
        // TODO this may need updating depending on the rules of what
        // CodeDefenders identifies as uncoverable
    ...
    public void testTestHasCompileTimeConstants() {
        GameClass gc = new GameClass("Option", "Option", "src/test/resources/itests/sources/Option/Option.java",
